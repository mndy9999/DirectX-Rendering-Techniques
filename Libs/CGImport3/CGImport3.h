...
// Note: In current version of CGImport this does nothing - reserved for later)
CGIMPORT3_API void init_CGImport(void);

// Generic model loading interface (determines filetype from extension (assumed to be the last 3 characters of filepath)
CGIMPORT3_API CGModel* loadModel(const wchar_t* filepath);
